...
async function fetchInventoryChanges() {
    try {
        const response = await fetch("http://192.168.78.207:3000/api/inventory/inventory-changes");
...
function fetchTodayDefects() {
    fetch('http://192.168.78.207:3000/api/defects/today', {
        headers: {
...
async function fetchLowStockCount() {
    try {
        const response = await fetch('http://192.168.78.207:3000/api/dashboard/low-stock');
...
async function fetchTotalSalesOrders() {
    try {
        const response = await fetch('http://192.168.78.207:3000/api/sales/total-orders');
...
async function fetchInventoryOverview() {
    try {
        const response = await fetch('http://192.168.78.207:3000/api/inventory/current');
        const data = await response.json();
