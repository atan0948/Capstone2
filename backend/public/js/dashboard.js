...
async function fetchInventoryChanges() {
    try {
        const response = await fetch(`${BASE_URL}/api/inventory/inventory-changes`);
...
function fetchTodayDefects() {
    fetch(`${BASE_URL}/api/defects/today`, {
        headers: {
...
async function fetchLowStockCount() {
    try {
        const response = await fetch(`${BASE_URL}/api/dashboard/low-stock`);
...
async function fetchTotalSalesOrders() {
    try {
        const response = await fetch(`${BASE_URL}/api/sales/total-orders`);
...
async function fetchInventoryOverview() {
    try {
        const response = await fetch(`${BASE_URL}/api/inventory/current`);
        const data = await response.json();
